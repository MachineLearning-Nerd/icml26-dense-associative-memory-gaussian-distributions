...
The authors' repository supplies a second primary record. Its deleted
executed notebook at immutable commit
`d5346b69a778ad316c031a8e0f2f13b5f86e6e15` has SHA-256
`4720167b74eb84cb35ec853863ab1f23eabcf837ccfe1b5e41d4496872e2ce3e`.
For the same beta-1, 100-fold-radius configuration it prints
`Converged: 521/750` and final mean W2 `0.157643` after five updates.
That hidden author output agrees with the published panel and
independently contradicts one-step convergence.
